...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\whatsapp-bulk-messenger-primary\Python_Scientific'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\whatsapp-bulk-messenger-primary\Python_Scientific\Scripts\deactivate.nu'
